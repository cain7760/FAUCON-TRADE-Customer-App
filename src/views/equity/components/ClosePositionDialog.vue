...
<template>
  <el-dialog :model-value="modelValue" top="var(--ft-dialog-top)" width="650px" :teleported="false" :show-close="false" class="cp-dialog" @update:model-value="emit('update:modelValue', $event)">
