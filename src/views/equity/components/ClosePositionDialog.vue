...
<template>
  <el-dialog :model-value="modelValue" top="var(--ft-dialog-top)" width="980px" :teleported="false" :show-close="false" class="close-position-dialog" @update:model-value="emit('update:modelValue', $event)">
